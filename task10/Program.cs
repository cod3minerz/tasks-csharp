namespace MyVector
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            v.Add(1, 15);
            Console.WriteLine("После Add(1,15): " + v);
            
            Console.WriteLine("v.Get(2) = " + v.Get(2));
            
            v.Set(2, 25);
            Console.WriteLine("После Set(2,25): " + v);
            
            var sub = v.SubList(1, 3);
            Console.WriteLine("subList(1,3) = " + sub);
            
            int removed = v.Remove(0);
            Console.WriteLine("Удалили по индексу 0: " + removed + ", v = " + v);
            
            v.AddAll(new int[] { 40, 50 });
            Console.WriteLine("После AddAll {40,50}: " + v);
            
            v.RemoveRange(1, 3);
            Console.WriteLine("После RemoveRange(1,3): " + v);
            
            Console.WriteLine("Size = " + v.Size());
            
            var arr = v.ToArray(new int[0]);
