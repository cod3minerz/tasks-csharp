...
public class MyArrayList<T>
{
    ...
    // Преобразование в массив с возможностью передачи массива
...
class Program
{
    static void Main()
    {
        ...
        list.Add(1, 15);
        Console.WriteLine("После вставки 15 на индекс 1: " + string.Join(", ", list.ToArray()));

        list.RemoveAt(0);
        Console.WriteLine("После удаления элемента с индексом 0: " + string.Join(", ", list.ToArray()));
